...
An internet-native, multi-agentic web application built with **Jac** that quizzes users to discover their unhinged personality characteristics and generates personalized caricaturized avatars.
...
*(Jac template initialization & setup commands coming up)*
